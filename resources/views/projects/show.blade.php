<x-layout class="!w-4/5 mx-auto">

    <div class="grid grid-cols-5 gap-10 bg-slate-700 shadow-2xl p-10 rounded-md">

        <div class="col-span-2">
            <div class="h-48 w-full bg-cover bg-no-repeat rounded-sm bg-center bg-[url('{{ asset("images/{$project['image']}") }}')]"></div>
